"""Create the NeuroCade application schema."""
...
def upgrade() -> None:
    ...
    op.create_index("ix_background_jobs_state_queue", "background_jobs", ["state", "queue_name"])
    op.create_index("ix_background_jobs_finished_at", "background_jobs", ["finished_at"])
    ...
    op.create_index("ix_assistant_turns_case_id", "assistant_turns", ["case_id"])
    op.create_index("ix_assistant_turns_thread_id", "assistant_turns", ["thread_id"])
    op.create_index("ix_assistant_turns_thread_status", "assistant_turns", ["thread_id", "status"])
    op.create_index("ix_assistant_turns_user_id", "assistant_turns", ["user_id"])
    op.create_index("ix_assistant_turns_workspace_id", "assistant_turns", ["workspace_id"])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["case_id"], ["cases.id"], onupdate="CASCADE"),
        sa.ForeignKeyConstraint(["thread_id"], ["assistant_threads.id"]),
        sa.ForeignKeyConstraint(["turn_id"], ["assistant_turns.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"]),
        sa.ForeignKeyConstraint(["workspace_id"], ["workspaces.id"], onupdate="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("turn_id", "call_id", name="uq_assistant_tool_executions_turn_call"),
    )
    op.create_index("ix_assistant_tool_executions_case_id", "assistant_tool_executions", ["case_id"])
    op.create_index("ix_assistant_tool_executions_external_run", "assistant_tool_executions", ["external_run_id"])
    op.create_index("ix_assistant_tool_executions_thread_id", "assistant_tool_executions", ["thread_id"])
    op.create_index("ix_assistant_tool_executions_turn_id", "assistant_tool_executions", ["turn_id"])
    op.create_index("ix_assistant_tool_executions_turn_status", "assistant_tool_executions", ["turn_id", "status"])
    op.create_index("ix_assistant_tool_executions_user_id", "assistant_tool_executions", ["user_id"])
    op.create_index("ix_assistant_tool_executions_workspace_id", "assistant_tool_executions", ["workspace_id"])
